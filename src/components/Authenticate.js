...
//Creating a object as Authenticate 
const Authenticate = ({ setStatus }) => {
  //Creating the State for Email 
  const [email, setEmail] = useState('');
  const [loading, setLoading] = useState('');
  const [error, setError] = useState(null);
 //Creating a history object to redirect the user to the dashboard
  ...
  return (
    <div className="w-50 p-5 mt-5 mx-auto">
      <h1 className="h1 text-center">DFrame Client Login</h1>
...
//Exporting the Authenticate Component
